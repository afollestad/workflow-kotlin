...
import com.squareup.workflow.ImplicitWorkflow.Ctx
import com.squareup.workflow.ImplicitWorkflow.WorkflowState
import com.squareup.workflow.ImplicitWorkflowImpl.State
...
private class ImplicitWorkflowImpl<PropsT, RenderingT>(
  ...
  override fun render(
    props: PropsT,
    state: State,
    context: RenderContext<PropsT, State, Nothing>
  ...
  private inner class RenderContextCtx(
    ...
    private val context: RenderContext<PropsT, State, Nothing>
  ) : Ctx {
